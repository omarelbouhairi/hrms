...
if (isset($_SESSION['username']) && isset($_SESSION['id'])&& $_SESSION['role'] == 'HR Manager') {
    ...
    if ($_SESSION['role'] === 'HR Manager') {
        $user_query = "SELECT id, username, name, role, user_address, phone FROM users";
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($user_result)) {
                                ...
                                echo "<td>";
                                echo "<a href='edit_user_info.php?user_id=" . $row['id'] . "'>Edit</a> | ";
                                echo "<a href='delete_user.php?user_id=" . $row['id'] . "'>Delete</a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                            ?>
